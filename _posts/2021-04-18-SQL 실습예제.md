...
FROM(
SELECT DEPARTMENT_ID, ROUND(AVG(SALARY), 2) AS ASAL, RANK() OVER (ORDER BY ROUND(AVG(SALARY), 2) DESC) AS RNK
FROM EMPLOYEES E1 INNER JOIN
(SELECT FIRST_NAME, DEPARTMENT_ID, EMPLOYEE_ID, CASE WHEN COMMISSION_PCT IS NOT NULL
