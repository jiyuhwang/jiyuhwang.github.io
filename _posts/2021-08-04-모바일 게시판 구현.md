...
#fileBtn:hover, #addBtn:hover, #listBtn:hover {
	background-color: #ff8000;
}
</style>
<script type="text/javascript" src="resources/script/jquery/jquery-1.12.4.min.js"></script>
...
<body>
	...
	<form action="#" id="addForm" method="post">
		 <input type="text" id="bTitle" name="bTitle" placeholder="제목을 입력해주세요." /><br/>
		 <input type="text" id="bWriter" name="bWriter" placeholder="작성자를 입력해주세요." /><br/>
